...
public abstract class AbstractEngineConfiguration {
    ...
    /**
     * Define variable length for variables that have length, e.g. String, JSON, etc. The length verifier can be used to
     * throw an exception if the length exceeds a certain threshold and / or it can log a warning.
     */
    ...
    protected void defaultInitDbSqlSessionFactoryEntitySettings(List<Class<? extends Entity>> insertOrder,
        List<Class<? extends Entity>> deleteOrder, Collection<Class<? extends Entity>> immutableEntities) {
        if (insertOrder != null) {
