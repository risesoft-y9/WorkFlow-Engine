...
public interface ProcessTodoApi {
    ...
    Y9Result<Long> countByOrgUnitId();
    ...
    Y9Result<Y9FlowableCountModel> getCountByUserIdAndProcessDefinitionKey(@RequestParam String processDefinitionKey);
    ...
    Y9Result<Y9FlowableCountModel> getCountByUserIdAndSystemName(@RequestParam String systemName);
    ...
    Y9Page<TaskModel> getListByUserIdAndProcessDefinitionKey(@RequestParam String processDefinitionKey,
    ...
    Y9Page<TaskModel> getListByUserIdAndSystemName(@RequestParam @NotBlank String systemName,
        @RequestParam Integer page, @RequestParam Integer rows);
    ...
    Y9Page<TaskModel> getListByUserIdAndSystemName4xxx(@RequestParam(required = false) String systemName,
        @RequestParam(required = false) String processDefinitionKey, @RequestParam(required = false) String target,
        @RequestParam Integer page, @RequestParam Integer rows);
    ...
    Y9Result<Long> getTodoCountByUserIdAndProcessDefinitionKey(@RequestParam String userId,
    ...
    Y9Result<Long> getTodoCountByUserIdAndSystemName(@RequestParam String userId, @RequestParam String systemName);
    ...
    Y9Page<TaskModel> pageByUserId(@RequestParam Integer page, @RequestParam Integer rows);
    ...
    Y9Page<TaskModel> searchListByUserIdAndProcessDefinitionKey(@RequestParam String processDefinitionKey,
    ...
    Y9Page<TaskModel> searchListByUserIdAndSystemName(@RequestParam @NotBlank String systemName,
        @RequestParam(required = false) String searchTerm, @RequestParam Integer page, @RequestParam Integer rows);
