...
public interface ProcessTodoApi {
    ...
    Y9Result<Y9FlowableCountModel>
        getCountByUserIdAndProcessDefinitionKey(@RequestParam("processDefinitionKey") String processDefinitionKey);
    ...
    Y9Result<Y9FlowableCountModel> getCountByUserIdAndSystemName(@RequestParam("systemName") String systemName);
    ...
    Y9Page<TaskModel> getListByUserIdAndProcessDefinitionKey(
    ...
    Y9Page<TaskModel> getListByUserIdAndSystemName(@RequestParam("systemName") @NotBlank String systemName,
    ...
    Y9Page<TaskModel> getListByUserIdAndSystemName4xxx(
    ...
    Y9Result<Long> getTodoCountByUserIdAndProcessDefinitionKey(@RequestParam("userId") String userId,
    ...
    Y9Result<Long> getTodoCountByUserIdAndSystemName(@RequestParam("userId") String userId,
    ...
    Y9Page<TaskModel> pageByUserId(@RequestParam("page") Integer page, @RequestParam("rows") Integer rows);
    ...
    Y9Page<TaskModel> searchListByUserIdAndProcessDefinitionKey(
        @RequestParam("processDefinitionKey") String processDefinitionKey,
    ...
    Y9Page<TaskModel> searchListByUserIdAndSystemName(@RequestParam("systemName") @NotBlank String systemName,
        @RequestParam(value = "searchTerm", required = false) String searchTerm, @RequestParam("page") Integer page,
        @RequestParam("rows") Integer rows);
