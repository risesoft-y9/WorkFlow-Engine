...
public interface ProcessModelApi {
    ...
    Y9Result<Object> deleteModel(@RequestParam String modelId);
    ...
    Y9Result<Object> deployModel(@RequestParam String modelId);
    ...
    Y9Result<List<FlowableBpmnModel>> getModelList();
    ...
    Y9Result<String> getModelXml(@RequestParam String modelId);
    ...
    Y9Result<Object> saveModelXml(MultipartFile file);
