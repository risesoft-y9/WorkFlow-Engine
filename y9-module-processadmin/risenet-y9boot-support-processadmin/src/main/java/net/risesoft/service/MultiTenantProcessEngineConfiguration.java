...
public class MultiTenantProcessEngineConfiguration extends MultiSchemaMultiTenantProcessEngineConfiguration {
    ...
    public MultiTenantProcessEngineConfiguration(@Qualifier("jdbcTemplate4Public") JdbcTemplate jdbcTemplate4Public, @Qualifier("y9FlowableDS") HikariDataSource defaultDataSource, Y9Properties y9Config) {
    ...
    public MultiTenantProcessEngineConfiguration(@Qualifier("jdbcTemplate4Public") JdbcTemplate jdbcTemplate4Public, @Qualifier("y9FlowableDS") HikariDataSource defaultDataSource, Y9Properties y9Config, TenantInfoHolder tenantInfoHolder) {
