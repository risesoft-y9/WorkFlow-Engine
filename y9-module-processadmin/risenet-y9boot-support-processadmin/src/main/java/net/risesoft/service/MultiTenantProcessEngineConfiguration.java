...
public class MultiTenantProcessEngineConfiguration extends MultiSchemaMultiTenantProcessEngineConfiguration {
    ...
    public MultiTenantProcessEngineConfiguration(@Qualifier("jdbcTemplate4Public") JdbcTemplate jdbcTemplate, @Qualifier("y9FlowableDS") DruidDataSource defaultDataSource, Y9Properties y9Config) {
    ...
    public MultiTenantProcessEngineConfiguration(@Qualifier("jdbcTemplate4Public") JdbcTemplate jdbcTemplate, @Qualifier("y9FlowableDS") DruidDataSource defaultDataSource, Y9Properties y9Config, TenantInfoHolder tenantInfoHolder) {
