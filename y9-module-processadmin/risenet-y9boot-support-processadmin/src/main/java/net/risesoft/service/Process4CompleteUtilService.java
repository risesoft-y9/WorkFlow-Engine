...
public class Process4CompleteUtilService {
    ...
    public Process4CompleteUtilService(@Qualifier("jdbcTemplate4Tenant") JdbcTemplate jdbcTemplate, OfficeDoneInfo4PositionApi officeDoneInfo4PositionApi, OfficeDoneInfoApi officeDoneInfoApi, DataCenterApi dataCenterManager, OrgUnitApi orgUnitApi, ProcessParamApi processParamManager, ErrorLogApi errorLogManager, Y9Properties y9Conf, Process4MsgRemindService process4MsgRemindService) {
