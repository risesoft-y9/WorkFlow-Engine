...
public class HistoricTaskApiImpl implements HistoricTaskApi {
    ...
    public Y9Result<List<HistoricTaskInstanceModel>>
        findTaskByProcessInstanceIdOrByEndTimeAsc(@RequestParam String processInstanceId, @RequestParam String year) {
     ...
     */
    @Override
    public Y9Result<HistoricTaskInstanceModel> getById(@RequestParam String taskId) {
     ...
     */
    @Override
    public Y9Result<HistoricTaskInstanceModel> getByIdAndYear(@RequestParam String taskId, @RequestParam String year) {
     ...
     */
    @Override
    public Y9Result<List<HistoricTaskInstanceModel>> getByProcessInstanceId(@RequestParam String processInstanceId,
    ...
    @Override
    public Y9Result<List<HistoricTaskInstanceModel>>
        getByProcessInstanceIdOrderByEndTimeDesc(@RequestParam String processInstanceId, String year) {
        List<HistoricTaskInstance> list =
     ...
     */
    @Override
    public Y9Result<Long> getFinishedCountByExecutionId(@RequestParam String executionId) {
     ...
     */
    @Override
    public Y9Result<HistoricTaskInstanceModel> getThePreviousTask(@RequestParam String taskId) {
     ...
     */
    @Override
    public Y9Result<List<HistoricTaskInstanceModel>> getThePreviousTasks(@RequestParam String taskId) {
     ...
     */
    @Override
    public Y9Result<Object> setTenantId(@RequestParam String taskId) {
