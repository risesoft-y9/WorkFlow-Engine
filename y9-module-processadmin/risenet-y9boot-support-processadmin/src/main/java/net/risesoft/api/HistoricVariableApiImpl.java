...
public class HistoricVariableApiImpl implements HistoricVariableApi {
     ...
     */
    @Override
    public Y9Result<List<HistoricVariableInstanceModel>>
     ...
     */
    @Override
    public Y9Result<HistoricVariableInstanceModel> getByProcessInstanceIdAndVariableName(
     ...
     */
    @Override
    public Y9Result<List<HistoricVariableInstanceModel>> getByTaskId(@RequestParam String taskId) {
     ...
     */
    @Override
    public Y9Result<HistoricVariableInstanceModel> getByTaskIdAndVariableName(@RequestParam String taskId,
        @RequestParam String variableName, String year) {
        HistoricVariableInstance hvi =
     ...
     */
    @Override
    public Y9Result<Map<String, Object>> getVariables(@RequestParam String processInstanceId,
        @RequestBody Collection<String> keys) {
        return Y9Result.success(customHistoricVariableService.getVariables(processInstanceId, keys));
    }
}
