CREATE TABLE `ff_act_ru_execution_backup` (
...
CREATE TABLE `ff_approveitem` (
  ...
  `TODOTASKURLPREFIX` varchar(200) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `ff_associatedfile` (
  ...
  `PROCESSSERIALNUMBER` varchar(255) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `ff_attachment` (
  ...
  `FULLPATH` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  ...
  `REALFILENAME` varchar(100) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `ff_bookmarkbind` (
  `ID` varchar(50) COLLATE utf8_bin NOT NULL,
  `BOOKMARKNAME` varchar(50) COLLATE utf8_bin NOT NULL,
  `BOOKMARKTYPE` int(11) NOT NULL,
  `COLUMNAME` varchar(50) COLLATE utf8_bin NOT NULL,
  `CREATETIME` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `TABLENAME` varchar(50) COLLATE utf8_bin NOT NULL,
  `UPDATETIME` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `USERID` varchar(50) COLLATE utf8_bin NOT NULL,
  `USERNAME` varchar(50) COLLATE utf8_bin NOT NULL,
  `WORDTEMPLATEID` varchar(50) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `ff_calendarconfig` (
  `ID` varchar(50) COLLATE utf8_bin NOT NULL,
  `everyYearHoliday` longtext COLLATE utf8_bin,
  `weekend2WorkingDay` varchar(1000) COLLATE utf8_bin DEFAULT NULL,
  `workingDay2Holiday` varchar(2000) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `ff_chaosong` (
  ...
  `ITEMNAME` varchar(100) COLLATE utf8_bin NOT NULL,
  `opinionContent` varchar(500) COLLATE utf8_bin DEFAULT NULL,
  `opinionGroup` varchar(38) COLLATE utf8_bin DEFAULT NULL,
  `opinionState` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `PROCESSINSTANCEID` varchar(50) COLLATE utf8_bin NOT NULL,
  `PROCESSSERIALNUMBER` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `READTIME` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `SENDDEPTID` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `SENDDEPTNAME` varchar(150) COLLATE utf8_bin DEFAULT NULL,
  `SENDERID` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `SENDERNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `STATUS` int(11) DEFAULT NULL,
  `SYSTEMNAME` varchar(50) COLLATE utf8_bin NOT NULL,
  `TASKID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `TENANTID` varchar(50) COLLATE utf8_bin NOT NULL,
  `TITLE` varchar(1000) COLLATE utf8_bin NOT NULL,
  `USERDEPTID` varchar(100) COLLATE utf8_bin NOT NULL,
  `USERDEPTNAME` varchar(150) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `ff_draftentity` (
  ...
  `NEIBU` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `ff_dynamicrole` (
  ...
  `CLASSPATH` varchar(500) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `ff_errorlog` (
  `ID` varchar(50) COLLATE utf8_bin NOT NULL,
  `CREATETIME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `ERRORFLAG` varchar(100) COLLATE utf8_bin NOT NULL,
  `ERRORTYPE` varchar(100) COLLATE utf8_bin NOT NULL,
  `EXTENDFIELD` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `PROCESSINSTANCEID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `TASKID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `ff_item_button_role` (
  `ID` varchar(38) COLLATE utf8_bin NOT NULL,
  `ITEMBUTTONID` varchar(50) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `ff_item_buttonbind` (
  ...
  `PROCESSDEFINITIONID` varchar(100) COLLATE utf8_bin NOT NULL,
  `TABINDEX` int(11) DEFAULT NULL,
...
CREATE TABLE `ff_item_opinionframe_role` (
  `ID` varchar(38) COLLATE utf8_bin NOT NULL,
  `ITEMOPINIONFRAMEID` varchar(50) COLLATE utf8_bin NOT NULL,
  `ROLEID` varchar(50) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `ff_item_organword` (
  ...
  `PROCESSDEFINITIONID` varchar(200) COLLATE utf8_bin NOT NULL,
  `TASKDEFKEY` varchar(100) COLLATE utf8_bin NOT NULL,
  `USERID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `USERNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
CREATE TABLE `ff_item_organword_role` (
  `ID` varchar(38) COLLATE utf8_bin NOT NULL,
  `ITEMORGANWORDBINDID` varchar(50) COLLATE utf8_bin NOT NULL,
  `ROLEID` varchar(50) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `ff_item_permission` (
  `ID` varchar(255) COLLATE utf8_bin NOT NULL,
  `CREATDATE` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `ITEMID` varchar(55) COLLATE utf8_bin NOT NULL,
  `PROCESSDEFINITIONID` varchar(255) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `ff_item_printtemplate_bind` (
  `ID` varchar(38) COLLATE utf8_bin NOT NULL,
  `ITEMID` varchar(55) COLLATE utf8_bin NOT NULL,
  `TEMPLATEID` varchar(38) COLLATE utf8_bin NOT NULL,
  `TEMPLATENAME` varchar(100) COLLATE utf8_bin NOT NULL,
  `TEMPLATETYPE` varchar(10) COLLATE utf8_bin NOT NULL,
  `TEMPLATEURL` varchar(100) COLLATE utf8_bin NOT NULL,
  `TENANTID` varchar(50) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `ff_item_taskconf` (
  ...
  `TASKDEFKEY` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `TENANTID` varchar(50) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `ff_item_viewconf` (
  `ID` varchar(38) COLLATE utf8_bin NOT NULL,
  `COLUMNNAME` varchar(50) COLLATE utf8_bin NOT NULL,
  `CREATETIME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `DISPLAYALIGN` varchar(10) COLLATE utf8_bin NOT NULL,
  `DISPLAYNAME` varchar(50) COLLATE utf8_bin NOT NULL,
  `DISPLAYWIDTH` varchar(50) COLLATE utf8_bin NOT NULL,
  `ITEMID` varchar(50) COLLATE utf8_bin NOT NULL,
  `TABINDEX` int(11) DEFAULT NULL,
  ...
  `USERID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `USERNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `VIEWTYPE` varchar(10) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `ff_item_y9formbind` (
  `ID` varchar(38) COLLATE utf8_bin NOT NULL,
  `FORMID` varchar(38) COLLATE utf8_bin NOT NULL,
  `FORMNAME` varchar(55) COLLATE utf8_bin NOT NULL,
  `ITEMID` varchar(55) COLLATE utf8_bin NOT NULL,
  `PROCESSDEFINITIONID` varchar(255) COLLATE utf8_bin NOT NULL,
  `SHOWDOCUMENTTAB` bit(1) DEFAULT NULL,
  `SHOWFILETAB` bit(1) DEFAULT NULL,
...
CREATE TABLE `ff_office_follow` (
  ...
  `BUREAUID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `BUREAUNAME` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `CREATETIME` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `DOCUMENTTITLE` varchar(500) COLLATE utf8_bin DEFAULT NULL,
  `FILETYPE` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `handleTerm` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `ITEMID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `JINJICHENGDU` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `NUMBERS` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `PROCESSINSTANCEID` varchar(50) COLLATE utf8_bin NOT NULL,
  `PROCESSSERIALNUMBER` varchar(50) COLLATE utf8_bin NOT NULL,
  `sendDept` varchar(150) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `ff_opinion` (
  `ID` varchar(38) COLLATE utf8_bin NOT NULL,
  `AGENTUSERDEPTID` varchar(38) COLLATE utf8_bin DEFAULT NULL,
  `AGENTUSERDEPTNAME` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `AGENTUSERID` varchar(38) COLLATE utf8_bin DEFAULT NULL,
  `AGENTUSERNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  ...
  `MODIFYDATE` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `OPINIONFRAMEMARK` varchar(50) COLLATE utf8_bin NOT NULL,
  `POSITIONID` varchar(38) COLLATE utf8_bin DEFAULT NULL,
  `PROCESSINSTANCEID` varchar(64) COLLATE utf8_bin DEFAULT NULL,
  `PROCESSSERIALNUMBER` varchar(38) COLLATE utf8_bin NOT NULL,
  `PROCESSTRACKID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `TASKID` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `TENANTID` varchar(50) COLLATE utf8_bin NOT NULL,
  `USERID` varchar(38) COLLATE utf8_bin NOT NULL,
  `USERNAME` varchar(50) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`ID`)
...
CREATE TABLE `ff_organword_propty` (
  ...
  `NAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `ORGANWORDID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `ff_process_param` (
  `ID` varchar(50) COLLATE utf8_bin NOT NULL,
  `BUREAUIDS` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `COMPLETER` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `CREATETIME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `CUSTOMLEVEL` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `CUSTOMNUMBER` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `DEPTIDS` varchar(4000) COLLATE utf8_bin DEFAULT NULL,
  `isSendSms` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `isShuMing` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `ITEMID` varchar(50) COLLATE utf8_bin NOT NULL,
  `ITEMNAME` varchar(50) COLLATE utf8_bin NOT NULL,
  `PROCESSINSTANCEID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `PROCESSSERIALNUMBER` varchar(50) COLLATE utf8_bin NOT NULL,
  `SEARCHTERM` longtext COLLATE utf8_bin NOT NULL,
  `SENDED` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `smsContent` varchar(2000) COLLATE utf8_bin DEFAULT NULL,
  `smsPersonId` longtext COLLATE utf8_bin,
  `sponsorGuid` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `STARTOR` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `STARTORNAME` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `SYSTEMCNNAME` varchar(50) COLLATE utf8_bin NOT NULL,
  `SYSTEMNAME` varchar(50) COLLATE utf8_bin NOT NULL,
  `TITLE` varchar(1000) COLLATE utf8_bin NOT NULL,
  `TODOTASKURLPREFIX` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `ff_receivedepartment` (
  ...
  `DEPTNAME` varchar(200) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `ff_receiveperson` (
  ...
  `DEPTID` varchar(50) COLLATE utf8_bin NOT NULL,
  `DEPTNAME` varchar(200) COLLATE utf8_bin NOT NULL,
  `PERSONDEPTID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `PERSONID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `ff_speakinfo` (
  ...
  `PROCESSINSTANCEID` varchar(50) COLLATE utf8_bin NOT NULL,
  `READUSERID` varchar(2000) COLLATE utf8_bin DEFAULT NULL,
  `UPDATETIME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `USERID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `USERNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
CREATE TABLE `ff_subtable` (
  ...
  `MODIFYDATE` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `USERNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `Y9FORMID` varchar(100) COLLATE utf8_bin NOT NULL,
  `Y9TABLEID` varchar(100) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UK_gn81e19mtkfuboopb0nn8u2vc` (`MARK`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

CREATE TABLE `ff_subtable_field` (
  `ID` varchar(38) COLLATE utf8_bin NOT NULL,
  `CREATEDATE` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `DISPLAYALIGN` varchar(10) COLLATE utf8_bin NOT NULL,
  `DISPLAYNAME` varchar(50) COLLATE utf8_bin NOT NULL,
  `DISPLAYWIDTH` varchar(50) COLLATE utf8_bin NOT NULL,
  `MODIFYDATE` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `SUBTABLEID` varchar(50) COLLATE utf8_bin NOT NULL,
  `TABINDEX` int(11) DEFAULT NULL,
  `TABLECOLUMN` varchar(100) COLLATE utf8_bin NOT NULL,
  `USERNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `ff_taskvariable` (
  `ID` varchar(50) COLLATE utf8_bin NOT NULL,
  `CREATETIME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `KEYNAME` varchar(100) COLLATE utf8_bin NOT NULL,
  `PROCESSINSTANCEID` varchar(50) COLLATE utf8_bin NOT NULL,
  `TASKID` varchar(50) COLLATE utf8_bin NOT NULL,
  `TEXT` longtext COLLATE utf8_bin,
  `UPDATETIME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `ff_workorderperson_bind` (
  `ID` varchar(38) COLLATE utf8_bin NOT NULL,
  `CREATETIME` datetime(6) DEFAULT NULL,
  `ISVTENANTID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `PERSONID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `PERSONNAME` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `SYSTEMID` varchar(50) COLLATE utf8_bin NOT NULL,
  `SYSTEMNAME` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `SYSTEMUSERID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `SYSTEMUSERNAME` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

CREATE TABLE `y9form_define` (
  `ID` varchar(38) COLLATE utf8_bin NOT NULL,
  `CSSURL` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `FILECONTENT` longblob,
  `FILENAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `FORMNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `FORMTYPE` int(11) DEFAULT NULL,
  `INITDATAURL` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `JSURL` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `ORIGINALCONTENT` longtext COLLATE utf8_bin,
  `PERSONID` varchar(38) COLLATE utf8_bin DEFAULT NULL,
  `RESULTCONTENT` longtext COLLATE utf8_bin,
  `SYSTEMCNNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `SYSTEMNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `y9form_element` (
  `ID` varchar(38) COLLATE utf8_bin NOT NULL,
  `COMPONENTPROPERTY` longtext COLLATE utf8_bin,
  `COMPONENTTYPE` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `ELEMENTID` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `ELEMENTNAME` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `ELEMENTTYPE` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `FIELDCNNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `FIELDNAME` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `FORMID` varchar(38) COLLATE utf8_bin DEFAULT NULL,
  `STATUS` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `TABLEID` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `TABLENAME` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `y9form_element_perm` (
  ...
  `ELEMENTTYPE` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `FORMID` varchar(38) COLLATE utf8_bin DEFAULT NULL,
  `PROCESSDEFINITIONID` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `READROLEID` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `READROLENAME` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `TASKDEFKEY` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `WRITEROLEID` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `WRITEROLENAME` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `y9form_optionvalue` (
  ...
  `DEFAULTSELECTED` int(11) NOT NULL,
  `NAME` varchar(255) COLLATE utf8_bin NOT NULL,
  `TABINDEX` int(11) NOT NULL,
  `TYPE` varchar(255) COLLATE utf8_bin NOT NULL,
  `UPDATETIME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `y9form_table` (
  `ID` varchar(38) COLLATE utf8_bin NOT NULL,
  `CREATETIME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `OLDTABLENAME` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `SYSTEMCNNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `SYSTEMNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `TABLEALIAS` varchar(4) COLLATE utf8_bin DEFAULT NULL,
  `TABLECNNAME` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `TABLEMEMO` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `TABLENAME` varchar(30) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `y9form_table_field` (
  ...
  `FIELDCNNAME` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `FIELDLENGTH` int(11) DEFAULT NULL,
  `FIELDNAME` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `FIELDTYPE` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `ISMAYNULL` int(11) DEFAULT NULL,
  `ISSYSTEMFIELD` int(11) DEFAULT NULL,
  `OLDFIELDNAME` varchar(30) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `y9form_validtype` (
  ...
  `TENANTID` varchar(38) COLLATE utf8_bin DEFAULT NULL,
  `UPDATETIME` datetime(6) DEFAULT NULL,
  `VALIDCNNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `VALIDCONTENT` longtext COLLATE utf8_bin,
  `VALIDNAME` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `VALIDTYPE` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
