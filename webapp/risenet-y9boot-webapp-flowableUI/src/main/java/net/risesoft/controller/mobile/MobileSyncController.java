...
public class MobileSyncController {
            ...
            for (Map<String, Object> map : list) {
                ...
                try {
                    ...
                    sql3 = "DELETE" + " FROM" + "	ACT_GE_BYTEARRAY" + " WHERE" + "	ID_ IN (" + "		SELECT"
                        ...
                        + "			 v.PROC_INST_ID_ = '" + processInstanceId + "'" + "		  AND v.NAME_ = 'users'"
                        + "       ) TT" + "	)";
                    // 删除二进制数据表
                    jdbcTemplate.execute(sql3);
    ...
    private String getffActRuExecutionSql(String year, String processInstanceId) {
        String sql3 = "INSERT INTO FF_ACT_RU_EXECUTION_" + year + " (" + "	ID_," + "	ACT_ID_," + "	IS_ACTIVE_,"
            + "	BUSINESS_KEY_," + "	CACHED_ENT_STATE_," + "	CALLBACK_ID_," + "	CALLBACK_TYPE_," + "	IS_CONCURRENT_,"
            + "	IS_COUNT_ENABLED_," + "	DEADLETTER_JOB_COUNT_," + "	IS_EVENT_SCOPE_," + "	EVT_SUBSCR_COUNT_,"
            + "	ID_LINK_COUNT_," + "	JOB_COUNT_," + "	LOCK_TIME_," + "	IS_MI_ROOT_," + "	NAME_,"
            + "	PARENT_ID_," + "	PROC_DEF_ID_," + "	PROC_INST_ID_," + "	REV_," + "	ROOT_PROC_INST_ID_,"
            + "	IS_SCOPE_," + "	START_ACT_ID_," + "	START_TIME_," + "	START_USER_ID_," + "	SUPER_EXEC_,"
            + "	SUSP_JOB_COUNT_," + "	SUSPENSION_STATE_," + "	TASK_COUNT_," + "	TENANT_ID_,"
            + "	TIMER_JOB_COUNT_," + "	VAR_COUNT_" + " ) SELECT" + "	ID_," + "	ACT_ID_," + "	IS_ACTIVE_,"
            + "	BUSINESS_KEY_," + "	CACHED_ENT_STATE_," + "	CALLBACK_ID_," + "	CALLBACK_TYPE_," + "	IS_CONCURRENT_,"
            + "	IS_COUNT_ENABLED_," + "	DEADLETTER_JOB_COUNT_," + "	IS_EVENT_SCOPE_," + "	EVT_SUBSCR_COUNT_,"
            + "	ID_LINK_COUNT_," + "	JOB_COUNT_," + "	LOCK_TIME_," + "	IS_MI_ROOT_," + "	NAME_,"
            + "	PARENT_ID_," + "	PROC_DEF_ID_," + "	PROC_INST_ID_," + "	REV_," + "	ROOT_PROC_INST_ID_,"
            + "	IS_SCOPE_," + "	START_ACT_ID_," + "	START_TIME_," + "	START_USER_ID_," + "	SUPER_EXEC_,"
            + "	SUSP_JOB_COUNT_," + "	SUSPENSION_STATE_," + "	TASK_COUNT_," + "	TENANT_ID_,"
            + "	TIMER_JOB_COUNT_," + "	VAR_COUNT_" + " FROM" + "	FF_ACT_RU_EXECUTION_BACKUP F" + " WHERE"
            + "	F.PROC_INST_ID_ = '" + processInstanceId + "'";
        return sql3;
    }
        ...
        try {
            ...
            for (Map<String, Object> map : list) {
                ...
                try {
                    ...
                    // 处理参与人
                    sql = "SELECT i.USER_ID_ from ACT_HI_IDENTITYLINK_2020 i where i.PROC_INST_ID_ = '"
                        + processInstanceId + "'";
