...
public class WpsRestController {
	...
	@ResponseBody
	public void getTaoHongTemplate(
		@RequestParam(required = false) String tenantId,
		@RequestParam(required = false) String userId,
		@RequestParam(required = false) String templateGuid, HttpServletResponse response) {
	...
	@ResponseBody
	public List<Map<String, Object>> taoHongTemplateList(
		@RequestParam(required = false) String tenantId,
		@RequestParam(required = false) String userId) {
	...
	public Map<String, Object> upload(
		...
		@RequestParam(required = false) String istaohong,
		...
		try {
			...
			String fileType = !fileName.contains(".") ? ".docx" : fileName.substring(fileName.lastIndexOf(".")).toLowerCase();// 文件类型
