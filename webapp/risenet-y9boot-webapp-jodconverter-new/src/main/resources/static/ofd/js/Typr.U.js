Typr["U"] = {
    ...
    "glyphToPath": function (font, gid, noColor) {
        ...
        var SVG = font["SVG "], CFF = font["CFF "], COLR = font["COLR"], CBLC = font["CBLC"], CBDT = font["CBDT"],
            sbix = font["sbix"], upng = window["UPNG"];
        var U = Typr["U"];
        ...
        function ptc(path, ctx) {
            ...
            for (var j = 0; j < cmds.length; j++) {
                ...
                if (cmd == "M") {
                    ...
                    var x0 = crds[c], y0 = crds[c + 1], x1 = crds[c + 2], y1 = crds[c + 3], x2 = crds[c + 4],
                        y2 = crds[c + 5], x3 = crds[c + 6], y3 = crds[c + 7];
                    c += 8;
