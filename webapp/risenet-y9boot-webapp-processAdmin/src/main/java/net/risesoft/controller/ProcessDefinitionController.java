...
public class ProcessDefinitionController {
	...
	public Map<String, Object> getTaskByProcDef(@RequestParam String processDefinitionId) {
		...
		List<FlowElement> activitieList = workflowProcessDefinitionService.getFilteredActivityImpls(processDefinitionId);
	...
	public Map<String, Object> getTaskMap(@RequestParam(required = false) String processDefinitionId) {
		...
		if (StringUtils.isNotBlank(processDefinitionId)) {
			List<String> filterList = new ArrayList<String>();
			filterList.add(SysVariables.STARTEVENT);
			List<FlowElement> list = workflowProcessDefinitionService.getFilteredActivityImpls(processDefinitionId, filterList);
