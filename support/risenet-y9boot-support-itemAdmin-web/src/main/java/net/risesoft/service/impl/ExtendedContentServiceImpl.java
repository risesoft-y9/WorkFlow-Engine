...
public class ExtendedContentServiceImpl implements ExtendedContentService {
	...
	public List<Map<String, Object>> contentList(String processSerialNumber, String taskId, String itembox, String category) {
		...
		try {
			...
			if (ItemBoxTypeEnum.TODO.getValue().equalsIgnoreCase(itembox) || ItemBoxTypeEnum.ADD.getValue().equalsIgnoreCase(itembox) || ItemBoxTypeEnum.DRAFT.getValue().equalsIgnoreCase(itembox)) {
