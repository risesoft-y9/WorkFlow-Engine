...
public class ItemTaskConfServiceImpl implements ItemTaskConfService {
    ...
    public void copyTaskConf(String itemId, String processDefinitionId) {
        ...
        if (currentPd.getVersion() > 1) {
            ...
            List<ItemTaskConf> confList =
                taskConfRepository.findByItemIdAndProcessDefinitionId(itemId, previouspd.getId());
            ...
            for (Map<String, Object> map : nodes) {
                ...
                ItemTaskConf currentConf = this.findByItemIdAndProcessDefinitionIdAndTaskDefKey4Own(itemId,
                    processDefinitionId, currentTaskDefKey);
                if (null == currentConf) {
