...
public class ActRuDetailApiImpl implements ActRuDetailApi {
    ...
    public List<ActRuDetailModel> findByProcessInstanceIdAndStatus(String tenantId, String processInstanceId,
        int status) {
        Y9LoginUserHolder.setTenantId(tenantId);
    ...
    public ActRuDetailModel findByProcessSerialNumberAndAssignee(String tenantId, String processSerialNumber,
        String assignee) {
        Y9LoginUserHolder.setTenantId(tenantId);
    ...
    public List<ActRuDetailModel> findByProcessSerialNumberAndStatus(String tenantId, String processSerialNumber,
        int status) {
        Y9LoginUserHolder.setTenantId(tenantId);
        List<ActRuDetail> actRuDetailList =
    ...
    public boolean removeByProcessSerialNumberAndAssignee(String tenantId, String processSerialNumber,
        String assignee) {
        Y9LoginUserHolder.setTenantId(tenantId);
