...
public interface DraftEntityRepository extends JpaRepository<DraftEntity, String>, JpaSpecificationExecutor<DraftEntity> {
     ...
     * @return
     */
    public Page<DraftEntity> findBySystemNameAndCreaterIdAndTitleLikeAndDelFlagFalse(String systemName, String userId, String title, Pageable pageable);
     ...
     * @return
     */
    public Page<DraftEntity> findBySystemNameAndCreaterIdAndTitleLikeAndDelFlagTrue(String systemName, String userId, String title, Pageable pageable);
