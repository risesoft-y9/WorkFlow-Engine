...
public interface ItemOpinionFrameBindRepository extends JpaRepository<ItemOpinionFrameBind, String>, JpaSpecificationExecutor<ItemOpinionFrameBind> {
    ...
    ItemOpinionFrameBind findByItemIdAndProcessDefinitionIdAndOpinionFrameMarkAndTaskDefKeyIsNull(String itemId, String processDefinitionId, String opinionFrameMark);
    ...
    List<ItemOpinionFrameBind> findByItemIdAndProcessDefinitionIdAndTaskDefKeyOrderByCreateDateAsc(String itemId, String processDefinitionId, String taskDefKey);

    List<ItemOpinionFrameBind> findByItemIdAndProcessDefinitionIdOrderByCreateDateAsc(String itemId, String processDefinitionId);
