...
public class Y9Form implements Serializable {
    ...
    @org.hibernate.annotations.Comment("表单类型")
    ...
    @org.hibernate.annotations.Comment("表单模板类型")
    private Integer templateType = 1;

    @Column(name = "FILENAME", length = 50)
    @org.hibernate.annotations.Comment("模板文件名称")
    private String fileName;

    @Lob
    @Column(name = "FILECONTENT")
    @org.hibernate.annotations.Comment("模板文件内容")
    private byte[] fileContent;

    @Lob
    @Column(name = "FORMJSON")
    @org.hibernate.annotations.Comment("表单json")
    private String formJson;

    @Lob
    @Column(name = "ORIGINALCONTENT")
    @org.hibernate.annotations.Comment("原始的页面内容")
    private String originalContent;

    @Lob
    @Column(name = "RESULTCONTENT")
    @org.hibernate.annotations.Comment("绑定后的页面内容")
    ...
    @org.hibernate.annotations.Comment("引用css")
    private String cssUrl;

    @Column(name = "JSURL", length = 255)
    @org.hibernate.annotations.Comment("引用js")
    private String jsUrl;

    @Column(name = "INITDATAURL", length = 255)
    @org.hibernate.annotations.Comment("初始化数据url路径")
