...
public class TodoApiImpl implements ProcessTodoApi {
    ...
    public Map<String, Object> getCountByUserId(String tenantId, String userId) {
    ...
    public Map<String, Object> getCountByUserIdAndSystemName(String tenantId, String userId, String systemName) {
        FlowableTenantInfoHolder.setTenantId(tenantId);
        Map<String, Object> map = new HashMap<String, Object>(16);
    ...
    public long getTodoCountByUserId(String tenantId, String userId) {
        FlowableTenantInfoHolder.setTenantId(tenantId);
    ...
    public long getTodoCountByUserIdAndSystemName(String tenantId, String userId, String systemName) {
        FlowableTenantInfoHolder.setTenantId(tenantId);
