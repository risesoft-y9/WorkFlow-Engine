    ...
    public List<Map<String, Object>> getListMap(String processInstanceId) {
        ...
        for (int i = 0; i < results.size(); i++) {
            ...
            if (StringUtils.isNotBlank(assignee)) {
                Position employee = positionManager.getPosition(Y9LoginUserHolder.getTenantId(), assignee);
                if (employee != null) {
                    ...
                    if (StringUtils.isNotBlank(ownerId)) {
                        Position ownerUser = positionManager.getPosition(Y9LoginUserHolder.getTenantId(), ownerId);
        ...
        if (seq.equals(name)) {
            ...
            for (Object obj : list) {
                ...
                if (StringUtils.isNotBlank(assigneeId)) {
                    ...
                    if (start) {
                        Map<String, Object> map = new HashMap<String, Object>(16);
                        Position employee = positionManager.getPosition(Y9LoginUserHolder.getTenantId(), user);
