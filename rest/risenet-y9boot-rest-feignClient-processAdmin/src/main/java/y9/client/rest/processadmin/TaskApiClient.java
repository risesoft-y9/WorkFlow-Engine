 ...
 * @date 2022/12/19
 */
@FeignClient(contextId = "TaskApiClient", name = "processAdmin", url = "${y9.common.processAdminBaseUrl}", path = "/services/rest/task")
public interface TaskApiClient extends TaskApi {
    ...
    TaskModel createWithVariables(@RequestParam("tenantId") String tenantId, @RequestParam("personId") String personId, @RequestParam("routeToTaskId") String routeToTaskId, @RequestParam("vars") Map<String, Object> vars, @RequestBody List<String> userIdList);
    ...
    TaskModel createWithVariables(@RequestParam("tenantId") String tenantId, @RequestParam("positionId") String positionId, @RequestParam("personId") String personId, @RequestParam("routeToTaskId") String routeToTaskId, @RequestParam("vars") Map<String, Object> vars,
