 ...
 * @date 2022/12/19
 */
@FeignClient(contextId = "ButtonOperation4PositionApiClient", name = "itemAdmin", url = "${y9.common.itemAdminBaseUrl}",
    path = "/services/rest/buttonOperation4Position")
public interface ButtonOperation4PositionApiClient extends ButtonOperation4PositionApi {
    ...
    public boolean directSend(@RequestParam("tenantId") String tenantId, @RequestParam("positionId") String positionId,
    ...
    public void reposition(@RequestParam("tenantId") String tenantId, @RequestParam("positionId") String positionId,
    ...
    public void rollBack(@RequestParam("tenantId") String tenantId, @RequestParam("positionId") String positionId,
    ...
    public void rollbackToSender(@RequestParam("tenantId") String tenantId,
    ...
    public void rollbackToStartor(@RequestParam("tenantId") String tenantId,
        @RequestParam("positionId") String positionId, @RequestParam("taskId") String taskId,
    ...
    public void specialComplete(@RequestParam("tenantId") String tenantId,
        @RequestParam("positionId") String positionId, @RequestParam("taskId") String taskId,
    ...
    public void takeback(@RequestParam("tenantId") String tenantId, @RequestParam("positionId") String positionId,
        @RequestParam("taskId") String taskId, @RequestParam("reason") String reason) throws Exception;
}
