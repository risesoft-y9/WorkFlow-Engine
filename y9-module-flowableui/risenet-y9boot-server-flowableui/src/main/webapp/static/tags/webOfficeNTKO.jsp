...
<span id="risesoftNTKOWord" style="color:red;display: none;">不能装载文档控件。请在检查浏览器的选项中检查浏览器的安全设置。或者下载安装<a
        href="${ctx}/static/tags/exe/risesoftNTKOWord.exe">跨浏览器插件</a></span>
