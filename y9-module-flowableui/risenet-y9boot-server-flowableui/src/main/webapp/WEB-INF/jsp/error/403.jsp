...
<div style="height: 100%;width: 100%;">
    <div style="margin:0 auto;width:750px;height:100%;border: none;background-color:#ffffff;">
        <img src="${ctx}/static/img/exception/forbidden.jpg"
        ...
        <span id="but"
              style="display:block;margin:5px auto;width: 150px;height: 35px;background-color:#1EA8A8;border-radius: 10px;cursor: pointer !important;">
