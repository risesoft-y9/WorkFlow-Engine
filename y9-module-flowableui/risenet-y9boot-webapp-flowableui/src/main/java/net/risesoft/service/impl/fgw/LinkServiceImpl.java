...
public class LinkServiceImpl implements LinkService {
    ...
    public Y9Page<Map<String, Object>> findPiByProcessId(String processId, String fromInstanceId, String searchMapStr, Integer page, Integer row) {
        if (OldUtil.newFwProcessId.equals(processId)){
            ...
            sql_content.append(linkListSql(processId,userId,1,searchMapStr));
...
//                        if (StringUtils.isNotBlank(activityInstanceId)){
                        CXLink.setLinkUrl("http://192.168.50.22/bpm/client/instance_open?activityInstanceId="+activityInstanceId);
//                        }
                    }
        ...
        try {
            if (StringUtils.isNotBlank(instanceId)){
                ...
                if (pm != null){
                    ...
                    String lshSql = "select lsh,guid from y9_form_fw where guid = '" + pm.getProcessSerialNumber() + "'";

                    List<String> res = jdbcTemplate.query(lshSql, (rs, rowNum) -> rs.getString("lsh") + "," + rs.getString("guid"));
                    String lsh = "";
                    String guid = "";
