...
//            pi.setInstanceexpiredate(rs.getString("instanceexpiredate") != null ?rs.getDate("instanceexpiredate") : new Date());
//            pi.setInstancereminddate(rs.getString("instancereminddate") != null ?rs.getDate("instancereminddate") :new Date());
