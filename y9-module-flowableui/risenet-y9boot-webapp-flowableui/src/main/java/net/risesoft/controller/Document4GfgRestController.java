    ...
    public Y9Result<Map<String, Object>> forwarding(@RequestParam @NotBlank String itemId,
        ...
        try {
            ...
            Y9Result<String> y9Result =
                documentApi.forwarding(Y9LoginUserHolder.getTenantId(), Y9LoginUserHolder.getPositionId(), taskId,
                    userChoice, routeToTaskId, sponsorHandle, sponsorGuid, variables);
