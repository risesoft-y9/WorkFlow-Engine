...
public class MobileV1SignController {
    ...
    public Y9Result<String> getDayOrHour(@RequestParam String type, @RequestParam String leaveStartTime, @RequestParam String leaveEndTime, @RequestParam String startSel, @RequestParam String endSel, @RequestParam String selStartTime, @RequestParam String selEndTime,
    ...
    public Y9Result<String> getDays(@RequestParam String startDate, @RequestParam String startSel, @RequestParam String endDate, @RequestParam String endSel, @RequestParam String dateType) {
        try {
            String tenantId = Y9LoginUserHolder.getTenantId();
            SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
            String dayStr = "";
