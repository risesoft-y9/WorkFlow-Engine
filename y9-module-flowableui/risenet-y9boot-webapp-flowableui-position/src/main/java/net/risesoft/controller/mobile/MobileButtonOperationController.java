...
public class MobileButtonOperationController {
    ...
    public void claim(@RequestHeader("auth-tenantId") String tenantId,
        @RequestHeader("auth-positionId") String positionId, @RequestParam @NotBlank String taskId,
    ...
    public void getItemBox(@RequestHeader("auth-tenantId") String tenantId, @RequestParam String taskId,
    ...
    public void handleParallel(@RequestHeader("auth-tenantId") String tenantId, @RequestParam @NotBlank String taskId,
        HttpServletResponse response) {
        Map<String, Object> map = new HashMap<>(16);
        try {
            Y9LoginUserHolder.setTenantId(tenantId);
    ...
    public void refuseClaim(@RequestHeader("auth-tenantId") String tenantId,
        ...
        @RequestParam @NotBlank String taskId, @RequestParam(required = false) Boolean isLastPerson4RefuseClaim,
        HttpServletResponse response) {
        Y9LoginUserHolder.setTenantId(tenantId);
        Map<String, Object> map = new HashMap<>(16);
        String activitiUser = "";
    ...
    public void reposition(@RequestHeader("auth-tenantId") String tenantId,
        @RequestHeader("auth-positionId") String positionId, @RequestParam @NotBlank String taskId,
    ...
    public void rollback(@RequestHeader("auth-tenantId") String tenantId,
        @RequestHeader("auth-positionId") String positionId, @RequestParam @NotBlank String taskId,
        HttpServletResponse response) {
        Map<String, Object> map = new HashMap<>(16);
        map.put(UtilConsts.SUCCESS, true);
    ...
    public void specialComplete(@RequestHeader("auth-tenantId") String tenantId,
        @RequestHeader("auth-userId") String userId, @RequestHeader("auth-positionId") String positionId,
        @RequestParam @NotBlank String taskId, @RequestParam(required = false) String reason,
        HttpServletResponse response) {
        Map<String, Object> map = new HashMap<>(16);
        Y9LoginUserHolder.setTenantId(tenantId);
        try {
    ...
    public void takeback(@RequestHeader("auth-tenantId") String tenantId,
        @RequestHeader("auth-positionId") String positionId, @RequestParam @NotBlank String taskId,
        HttpServletResponse response) {
        Y9LoginUserHolder.setTenantId(tenantId);
        Map<String, Object> map = new HashMap<>(16);
    ...
    public void unclaim(@RequestHeader("auth-tenantId") String tenantId, @RequestParam @NotBlank String taskId,
        HttpServletResponse response) {
        Y9LoginUserHolder.setTenantId(tenantId);
        Map<String, Object> map = new HashMap<>(16);
        try {
