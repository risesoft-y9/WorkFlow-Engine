...
public class MobileV1ChaoSongController {
    ...
    public Y9Page<Map<String, Object>> search(
            @RequestParam(required = false) String year, @RequestParam(required = false) String documentTitle, Integer status, int rows, int page) {
        Map<String, Object> map = new HashMap<String, Object>(16);
        try {
            String tenantId = Y9LoginUserHolder.getTenantId();
            String positionId = Y9LoginUserHolder.getPositionId();
    ...
    public Y9Result<String> send(
            @RequestParam(required = false) String processInstanceId, @RequestParam(required = false) String users, @RequestParam(required = false) String isSendSms, @RequestParam(required = false) String isShuMing, @RequestParam(required = false) String smsContent) {
