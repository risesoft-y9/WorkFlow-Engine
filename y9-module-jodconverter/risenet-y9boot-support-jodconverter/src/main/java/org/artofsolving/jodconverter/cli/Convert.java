...
public class Convert {
    ...
    public static void main(String[] arguments) throws ParseException, JSONException, IOException {
        ...
        boolean b = (outputFormat == null && fileNames.length != 2) || fileNames.length < 1;
        if (b) {
        ...
        if (commandLine.hasOption(OPTION_REGISTRY.getOpt())) {
            ...
            registry = new JsonDocumentFormatRegistry(FileUtils.readFileToString(registryFile, StandardCharsets.UTF_8));
        } else {
