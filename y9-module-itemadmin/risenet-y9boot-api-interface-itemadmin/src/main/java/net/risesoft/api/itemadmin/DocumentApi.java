...
public interface DocumentApi {
    ...
    Y9Result<DocumentDetailModel> addWithStartTaskDefKey(@RequestParam("tenantId") String tenantId,
    ...
    Y9Result<List<ItemButtonModel>> getButtons(@RequestParam("tenantId") String tenantId,
        @RequestParam("orgUnitId") String orgUnitId, @RequestParam(value = "taskId", required = false) String taskId);
    ...
    Y9Result<DocumentDetailModel> editRecycle(@RequestParam("tenantId") String tenantId,
        @RequestParam("orgUnitId") String orgUnitId, @RequestParam("processInstanceId") String processInstanceId,
        @RequestParam("mobile") boolean mobile);
    ...
    Y9Result<String> forwarding(@RequestParam("tenantId") String tenantId, @RequestParam("orgUnitId") String orgUnitId,
        @RequestParam("taskId") String taskId, @RequestParam("userChoice") String userChoice,
        @RequestParam("routeToTaskId") String routeToTaskId,
        @RequestParam(value = "sponsorHandle", required = false) String sponsorHandle,
        @RequestParam(value = "sponsorGuid", required = false) String sponsorGuid);
