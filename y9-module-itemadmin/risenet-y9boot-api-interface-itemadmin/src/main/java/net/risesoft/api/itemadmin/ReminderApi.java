...
public interface ReminderApi {
     ...
     */
    @GetMapping("/findById")
    Y9Result<ReminderModel> findById(@RequestParam String id);
    ...
    Y9Page<ReminderModel> findByProcessInstanceId(@RequestParam String processInstanceId, @RequestParam int page,
    ...
    Y9Page<ReminderModel> findBySenderIdAndProcessInstanceIdAndActive(@RequestParam String processInstanceId,
    ...
    Y9Page<ReminderModel> findByTaskId(@RequestParam String taskId, @RequestParam int page, @RequestParam int rows);
    ...
    Y9Result<String> saveReminder(@RequestParam String processInstanceId, @RequestBody String[] taskIds,
    ...
    Y9Result<String> sendReminderMessage(@RequestParam String remType, @RequestParam String procInstId,
    ...
    Y9Result<String> updateReminder(@RequestParam String id, @RequestParam String msgContent);
