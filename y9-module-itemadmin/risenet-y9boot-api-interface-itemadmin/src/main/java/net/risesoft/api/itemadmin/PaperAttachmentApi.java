...
public interface PaperAttachmentApi {
    ...
    Y9Result<List<PaperAttachmentModel>> findByProcessSerialNumber(@RequestParam("tenantId") String tenantId, @RequestParam("processSerialNumber") String processSerialNumber);
