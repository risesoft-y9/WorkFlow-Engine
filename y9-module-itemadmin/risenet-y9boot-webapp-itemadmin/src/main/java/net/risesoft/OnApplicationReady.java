...
public class OnApplicationReady implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public OnApplicationReady(@Qualifier("jdbcTemplate4Public") JdbcTemplate jdbcTemplate, Y9TenantDataSourceLookup y9TenantDataSourceLookup, InitTableDataService initTableDataService, Y9Properties y9Config) {
