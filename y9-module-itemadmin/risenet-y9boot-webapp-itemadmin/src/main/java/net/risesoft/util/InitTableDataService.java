...
public class InitTableDataService {
    ...
    public InitTableDataService(@Qualifier("jdbcTemplate4Tenant") JdbcTemplate jdbcTemplate4Tenant, SyncYearTableService syncYearTableService, SpmApproveItemRepository spmApproveItemRepository, OpinionFrameRepository opinionFrameRepository, DynamicRoleRepository dynamicRoleRepository, Y9TableRepository y9TableRepository, Y9TableFieldRepository y9TableFieldRepository, Y9FormRepository y9FormRepository, Y9FormFieldRepository y9FormFieldRepository, Y9FormItemBindRepository y9FormItemBindRepository, ItemPermissionRepository itemPermissionRepository, ItemOpinionFrameBindRepository itemOpinionFrameBindRepository, PrintTemplateItemBindRepository printTemplateItemBindRepository, ItemViewConfRepository itemViewConfRepository, TableManagerService tableManagerService, Y9Properties y9Config) {
