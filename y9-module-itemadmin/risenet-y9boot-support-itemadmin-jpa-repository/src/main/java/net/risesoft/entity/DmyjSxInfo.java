...
@Data
@Entity
@Table(name = "FF_DMYJSX_INFO")
@org.hibernate.annotations.Table(comment = "定密依据事项信息表", appliesTo = "FF_DMYJSX_INFO")
public class DmyjSxInfo implements Serializable {
    ...
    @Comment("定密依据事项")
    @Column(name = "dmyjsx", length = 100)
    private String dmyjsx;

    @Comment("定密依据事项值")
    @Column(name = "dmyjsxvalue", length = 100)
