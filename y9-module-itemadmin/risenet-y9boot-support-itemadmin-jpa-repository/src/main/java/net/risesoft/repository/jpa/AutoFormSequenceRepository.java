...
public interface AutoFormSequenceRepository
    ...
    AutoFormSequence findOne(String tenantId, String labelName, String character, Integer calendarYear);
    ...
    int updateSequence(String tenantId, String labelName, String character, Integer calendarYear);
}