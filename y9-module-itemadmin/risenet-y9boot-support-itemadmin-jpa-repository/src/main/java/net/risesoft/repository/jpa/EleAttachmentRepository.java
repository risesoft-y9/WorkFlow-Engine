...
public interface EleAttachmentRepository
    extends JpaRepository<EleAttachment, String>, JpaSpecificationExecutor<EleAttachment> {
    ...
    List<EleAttachment> findByProcessSerialNumberAndAttachmentTypeOrderByTabIndexAsc(String processSerialNumber,
        String attachmentType);

    List<EleAttachment> findByProcessSerialNumberAndAttachmentTypeOrderByUploadTimeDesc(String processSerialNumber,
        String attachmentType);
