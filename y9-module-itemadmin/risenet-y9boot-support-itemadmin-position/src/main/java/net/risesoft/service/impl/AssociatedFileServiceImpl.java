...
public class AssociatedFileServiceImpl implements AssociatedFileService {
    ...
    public boolean deleteAllAssociatedFile(String processSerialNumber, String delIds) {
        try {
            ...
            LOGGER.error("Error in deleteAllAssociatedFile", e);
        }
        return false;
    }
    ...
    public boolean deleteAssociatedFile(String processSerialNumber, String delId) {
        try {
            ...
            LOGGER.error("Error in deleteAssociatedFile", e);
        }
        return false;
    }
            ...
            if (associatedFile != null) {
                ...
                items.sort((o1, o2) -> {
                    ...
                    try {
                        ...
                        return Long.compare(startTime2.getTime(), startTime1.getTime());
                    } catch (Exception e) {
                        LOGGER.error("items sort error", e);
                    }
                    return -1;
                });
            }
                ...
                if (StringUtils.isNotBlank(associatedId)) {
                    ...
                    for (String id : associatedIds) {
                        ...
                        try {
                            ...
                            String startTime, endTime1, endTime;
                            if (hpim != null) {
                            ...
                            LOGGER.error("Error in getAssociatedFileList", e);
                        }
                    }
                }
                items.sort((o1, o2) -> {
                    ...
                    try {
                        Date endTimes1 = sdf2.parse((String) o1.get("endTimes"));
                        Date endTimes2 = sdf2.parse((String) o2.get("endTimes"));
                        return Long.compare(endTimes2.getTime(), endTimes1.getTime());
                    } catch (Exception e) {
                        LOGGER.error("items sort error", e);
                    }
                    return 0;
    ...
    public boolean saveAssociatedFile(String processSerialNumber, String processInstanceIds) {
        try {
            ...
            LOGGER.error("Error in saveAssociatedFile", e);
        }
        return false;
    }
