...
public class RelatedProcessRestController {
	...
	public Y9Result<String> save(@RequestParam(required = true) String parentItemId, @RequestParam(name = "ids") List<String> idList) {
		relatedProcessService.save(parentItemId,idList);
