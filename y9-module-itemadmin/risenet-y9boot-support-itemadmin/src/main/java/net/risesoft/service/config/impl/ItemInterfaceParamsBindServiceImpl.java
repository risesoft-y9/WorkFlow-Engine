...
public class ItemInterfaceParamsBindServiceImpl implements ItemInterfaceParamsBindService {
    ...
    @Override
    public List<ItemInterfaceParamsBind> listByItemIdAndInterfaceId(String itemId, String interfaceId) {
        return itemInterfaceParamsBindRepository.findByItemIdAndInterfaceIdOrderByCreateTimeDesc(itemId, interfaceId);
    }
