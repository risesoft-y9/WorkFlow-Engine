...
public class FormRestController {
    ...
    public Y9Result<Object> copyFormAndFieldBind(@RequestParam String systemName, @RequestParam String systemCnName,
        @RequestParam String copyFormId, @RequestParam String tableName) {
