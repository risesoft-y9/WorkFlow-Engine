...
public class ItemDoingApiImpl implements ItemDoingApi {
    ...
    public Y9Result<Integer> countByUserIdAndSystemName(@RequestParam String systemName) {
        int count = this.actRuDetailService.countBySystemNameAndAssigneeAndStatus(systemName,
            Y9FlowableHolder.getPositionId(), ActRuDetailStatusEnum.DOING);
    ...
    public Y9Page<ActRuDetailModel> findByDeptIdAndSystemName(@RequestParam String deptId,
        @RequestParam boolean isBureau, @RequestParam String systemName, @RequestParam Integer page,
    ...
    public Y9Page<ActRuDetailModel> findByUserIdAndSystemName(@RequestParam String systemName,
        ...
        Sort sort = Sort.by(Sort.Direction.DESC, ItemConsts.LASTTIME_KEY);
        Page<ActRuDetail> ardPage = this.actRuDetailService.pageBySystemNameAndAssigneeAndStatus(systemName,
            Y9FlowableHolder.getPositionId(), ActRuDetailStatusEnum.DOING, rows, page, sort);
        List<ActRuDetail> ardList = ardPage.getContent();
        ActRuDetailModel actRuDetailModel;
        List<ActRuDetailModel> modelList = new ArrayList<>();
        for (ActRuDetail actRuDetail : ardList) {
