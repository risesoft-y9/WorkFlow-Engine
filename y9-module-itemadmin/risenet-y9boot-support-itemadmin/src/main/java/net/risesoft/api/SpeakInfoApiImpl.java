...
public class SpeakInfoApiImpl implements SpeakInfoApi {
     ...
     */
    @Override
    public Y9Result<SpeakInfoModel> findById(@RequestParam String id) {
     ...
     */
    @Override
    public Y9Result<List<SpeakInfoModel>> findByProcessInstanceId(@RequestParam String processInstanceId) {
     ...
     */
    @Override
    public Y9Result<Integer> getNotReadCount(@RequestParam String processInstanceId) {
        return Y9Result.success(speakInfoService.getNotReadCount(processInstanceId, Y9LoginUserHolder.getPersonId()));
    }
     ...
     */
    @Override
    public Y9Result<String> saveOrUpdate(@RequestBody SpeakInfoModel speakInfoModel) {
