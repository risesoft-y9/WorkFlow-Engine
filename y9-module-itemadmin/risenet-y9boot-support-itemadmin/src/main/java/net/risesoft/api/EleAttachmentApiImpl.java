...
public class EleAttachmentApiImpl implements EleAttachmentApi {
     ...
     */
    @Override
    public Y9Result<List<EleAttachmentModel>> findByProcessSerialNumberAndAttachmentType(@RequestParam String tenantId,
        @RequestParam String processSerialNumber, String attachmentType) {
        Y9LoginUserHolder.setTenantId(tenantId);
     ...
     */
    @Override
    public Y9Result<Object> saveOrder(@RequestParam String tenantId, @RequestParam String id1,
        @RequestParam String id2) {
        Y9LoginUserHolder.setTenantId(tenantId);
        eleAttachmentService.saveOrder(id1, id2);
        return Y9Result.success();
    }
}
