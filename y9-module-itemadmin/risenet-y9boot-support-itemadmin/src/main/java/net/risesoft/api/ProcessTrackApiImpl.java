...
public class ProcessTrackApiImpl implements ProcessTrackApi {
     ...
     */
    @Override
    public Y9Result<Object> deleteById(@RequestParam String id) throws Exception {
     ...
     */
    @Override
    public Y9Result<List<ProcessTrackModel>> findByTaskId(@RequestParam String taskId) {
     ...
     */
    @Override
    public Y9Result<List<ProcessTrackModel>> findByTaskIdAsc(@RequestParam String taskId) {
        List<ProcessTrackModel> items = new ArrayList<>();
        try {
     ...
     */
    @Override
    public Y9Result<List<HistoryProcessModel>> processTrackList(@RequestParam String processInstanceId) {
        try {
     ...
     */
    @Override
    public Y9Result<List<HistoryProcessModel>> processTrackList4Simple(@RequestParam String processInstanceId) {
        try {
     ...
     */
    @Override
    public Y9Result<List<HistoryProcessModel>> processTrackListWithActionName(@RequestParam String processInstanceId) {
        try {
     ...
     */
    @Override
    public Y9Result<ProcessTrackModel> saveOrUpdate(@RequestBody ProcessTrackModel processTrackModel) throws Exception {
