...
public class Y9WordApiImpl implements Y9WordApi {
     ...
     */
    @Override
    public Y9Result<Object> deleteByIsTaoHong(@RequestParam String processSerialNumber,
     ...
     */
    @Override
    public Y9Result<Y9WordModel> exchangeFindWordByProcessSerialNumber(@RequestParam String processSerialNumber) {
        ...
        try {
            ...
            if (list != null && !list.isEmpty()) {
                ...
                Person user = personApi.get(Y9LoginUserHolder.getTenantId(), y9Word.getUserId()).getData();
     ...
     */
    @Override
    public Y9Result<Y9WordHistoryModel> findHistoryVersionDoc(@RequestParam String taskId) {
        ...
        if (null != historyWordList && !historyWordList.isEmpty()) {
            ...
            populateHistoryModel(history, historyWord, Y9LoginUserHolder.getTenantId());
        }
     ...
     */
    @Override
    public Y9Result<Y9WordModel> findWordByProcessSerialNumber(@RequestParam String processSerialNumber) {
        try {
            List<Y9Word> list = y9WordService.listByProcessSerialNumber(processSerialNumber);
            if (list != null && !list.isEmpty()) {
                Y9Word y9Word = list.get(0);
                ...
                OrgUnit orgUnit = orgUnitApi.getOrgUnit(Y9LoginUserHolder.getTenantId(), y9Word.getUserId()).getData();
     ...
     */
    @Override
    public Y9Result<List<Y9WordModel>> getWordList(@RequestParam String processSerialNumber) {
    ...
    @Override
    public Y9Result<Boolean> importY9Word(@RequestParam String docJson, @RequestParam String processSerialNumber) {
    ...
    @Override
    public Y9Result<String> openDocument(@RequestParam String processSerialNumber, @RequestParam String itemId,
        String bindValue) {
        // 尝试获取已存在的正文文件
     ...
     */
    @Override
    public Y9Result<String> openDocumentByProcessSerialNumber(@RequestParam String processSerialNumber) {
        // 获取套红文档
     ...
     */
    @Override
    public Y9Result<String> openDocumentTemplate(@RequestParam String templateGuid) {
     ...
     */
    @Override
    public Y9Result<String> openPdf(@RequestParam String processSerialNumber) {
        List<Y9Word> list = new ArrayList<>();
     ...
     */
    @Override
    public Y9Result<String> openRevokePdfAfterDocument(@RequestParam String processSerialNumber,
        @RequestParam String isTaoHong) {
        List<Y9Word> list = new ArrayList<>();
        if (StringUtils.isNotBlank(processSerialNumber) && StringUtils.isNotBlank(isTaoHong)) {
            list = y9WordService.listByProcessSerialNumberAndIstaohong(processSerialNumber, isTaoHong);
     ...
     */
    @Override
    public Y9Result<String> openTaoHong(@RequestParam String activitiUser) {
     ...
     */
    @Override
    public Y9Result<Y9WordInfo> showWord(@RequestParam String processSerialNumber, @RequestParam String itemId,
        String itembox, String taskId, String bindValue) {
        try {
     ...
     */
    @Override
    public Y9Result<List<TaoHongTemplateModel>> taoHongTemplateList(@RequestParam String currentBureauGuid) {
    ...
    public Y9Result<Boolean> uploadWord(@RequestParam String documentTitle, @RequestParam String fileType,
        @RequestParam String processSerialNumber, String isTaoHong, String docCategory, String taskId,
        String fileSizeString, @RequestParam String fileStoreId) {
        try {
            if (StringUtils.isBlank(processSerialNumber)) {
            ...
            if (existingWords.isEmpty()) {
                ...
                return handleExistingWord(existingWords.get(0), fileStoreId, fileSizeString, fileType,
                    processSerialNumber, isTaoHong, docCategory, taskId, Y9LoginUserHolder.getPersonId());
            }
        } catch (Exception e) {
     ...
     */
    @Override
    public Y9Result<Y9WordModel> wordDownload(@RequestParam String id) {
