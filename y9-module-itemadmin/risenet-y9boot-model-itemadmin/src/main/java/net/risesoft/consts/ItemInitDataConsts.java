...
public class ItemInitDataConsts {
     ...
     * 办件系统中文名，事项名称
     */
    public static final String SYSTEM_CN_NAME = "办件";
    /**
     * 办件系统英文名
     */
    public static final String SYSTEM_NAME = "banjian";
     ...
     * 监控管理员角色
     */
    public static final String MONITOR_ROLE = "监控管理员角色";

    /**
     * 监控管理员角色customId
     */
    public static final String MONITOR_ROLE_CUSTOM_ID = "itemMonitorRole";
