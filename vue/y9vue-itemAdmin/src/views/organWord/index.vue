  ...
  <div class="orgWordTable">
    <el-form ref="orgWordForm" :model="formData" :rules="rules">
        <y9Table :config="tableConfig" :filterConfig="filterConfig">
          <template #addBtn>
            <el-button class="global-btn-main" type="primary" @click="addOrganWord"><i class="ri-add-line"></i>新增</el-button>
          </template>
          ...
          <template #custom="{row,column,index}">
              <el-form-item prop="custom" v-if="editIndex === index">
          ...
          <template #opt="{row,column,index}">
            <div v-if="editIndex === index">
              <el-button class="global-btn-second" size="small" @click="saveData(orgWordForm)"><i class="ri-book-mark-line"></i>保存</el-button>
              <el-button class="global-btn-second" size="small" @click="cancalData(orgWordForm)"><i class="ri-close-line"></i>取消</el-button>
          </div>
          <div v-else>
            <el-button class="global-btn-second" size="small" @click="property(row)"><i class="ri-book-3-line"></i>机关代字</el-button>
            <el-button class="global-btn-second" size="small" @click="editOrganWord(row,index)"><i class="ri-edit-line"></i>修改</el-button>
            <el-button class="global-btn-danger" type="danger" size="small" @click="delOrganWord(row)"><i class="ri-delete-bin-line"></i>删除</el-button>
          </div>
          </template>
        </y9Table>
      </el-form>
