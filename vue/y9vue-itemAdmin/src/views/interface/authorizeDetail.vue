...
import {findByInterfaceId} from '@/api/itemAdmin/interface';
import {removeBind} from "@/api/itemAdmin/item/interfaceConfig";
...
async function getTableList() {
  let res = await findByInterfaceId(props.row.id);
