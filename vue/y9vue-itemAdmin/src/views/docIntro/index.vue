<template>
    <div class="container">
        <div class="sidebar" v-if="isDirectoryVisible">
            <h2>目录</h2>
            <y9Tree :data="tree" :props="treeProps" node-key="id" @node-click="handleNodeClick"></y9Tree>
        </div>
        <div class="contain" id="contain">
            <div class="flex justify-space-between mb-4 flex-wrap gap-4"
                 style="position: absolute;background-color: white;" :style="{ left: leftPosition }">
                <el-button @click="toggleDirectory" style="box-shadow: none;" link>
                    <el-icon size="17px">
            ...
            <div class="top-button">
                <el-button type="primary" @click="scrollTop" style="position: absolute" circle title="回到顶部">
                    <i class="ri-arrow-up-line" style="font-size: 18px;"></i>
                </el-button>
            </div>
            <v-md-preview :text="renderedHtml" ref="preview"></v-md-preview>
        </div>
    </div>
</template>
