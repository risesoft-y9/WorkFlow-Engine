...
-->
<template>
	<el-form ref="y9FormRef" class="newOrModifyField" :model="form" :rules="rules" :inline-message="true" :status-icon="true">
				...
				<tr>
					...
					<td class="rigthtd"  >
						<el-select v-model="form.formType">
							<el-option :key="1" label="主表单" :value="1"></el-option>
							<el-option :key="2" label="前置表单" :value="2"></el-option>
						</el-select>
					</td>
				</tr>
				<tr>
