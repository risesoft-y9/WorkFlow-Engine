            ...
            >
                ...
                <template #opt="{ row, column, index }">
                    <div v-if="editIndex === index">
                        <el-button class="global-btn-second" size="small" @click="saveData(viewTypeForm)"
                            ><i class="ri-book-mark-line"></i>保存
                        </el-button>
                        <el-button class="global-btn-second" size="small" @click="cancalData(viewTypeForm)"
...
<script lang="ts" setup>
    ...
    let { filterConfig, tableConfig, editIndex, isEdit, formData, isEmptyData } = toRefs(data);
