<template>
    <div style="height: 100%;width: 100%">
        ...
        <el-dialog v-model="dialogVisible" :close-on-click-modal="false" :close-on-press-escape="false" class="tishi"
                   title="日历设置"
                   width="20%">
...
const calendarOptions = {
    ...
    events: function (info, wrappedSuccess) {
        ...
        if (startdate.split("-")[0] != enddate.split("-")[0]) {//跨年
            let events = [];
    ...
    views: {
        ...
        dayGridMonth: {
            ...
            dayCellContent(item) {
                ...
                let html = {
                    html: `<div class="cDay" style="display: table;width: 100%;text-align: right;margin-right: 10px;">${cDay}</div>` +
