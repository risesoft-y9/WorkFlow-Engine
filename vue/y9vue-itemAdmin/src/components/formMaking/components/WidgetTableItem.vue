...
export default {
  ...
  props: ['element', 'select', 'index', 'data', 'platform', 'formKey','tableElement','fieldBind'],
  ...
  methods: {
    ...
    handleSelectWidget (index) {
      this.data[index].childTableInfo = this.tableElement.childTableInfo == undefined ? "" : this.tableElement.childTableInfo;//Y9设置子表信息
      this.selectWidget.childTableInfo = this.tableElement.childTableInfo == undefined ? "" : this.tableElement.childTableInfo;//设置子表信息
