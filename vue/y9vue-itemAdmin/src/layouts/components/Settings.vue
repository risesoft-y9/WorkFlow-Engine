...
<template>
    <!-- Form -->
    <el-dialog v-model="webSettingVisible"   class="index-layout-setting-list" title="网站设置" width="65%" class="ddd">
        <el-form :model="form">
            <el-form-item
                label="Name"
            ...
            <div class="Tip">
                <i class="ri-question-line"></i>&nbsp;网站名称
            </div>
            <el-form-item
                label="Logo"
                :label-width="formLabelWidth"
            ...
            <div class="Tip">
                <i class="ri-question-line"></i>&nbsp;logo设置
            </div>
            <el-form-item
                label="语言"
                :label-width="formLabelWidth"
            ...
            <el-form-item label="设置版本" :label-width="formLabelWidth">
            ...
            <el-form-item label="菜单布局" :label-width="formLabelWidth">
                ...
                <el-radio v-model="form.pcLayout" label="Y9Default sidebar-separate" size="large">sidebar-separate</el-radio>
            </el-form-item>
        </el-form>
        <template #footer>
            <span class="dialog-footer">
                <el-button @click="resetFunc()">
