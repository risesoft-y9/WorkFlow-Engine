...
//32位控件包的路径
var codebase="./tags/cab/ofctnewclsid.cab";
//64位控件包的路径
var codebase64="./tags/cab/ofctnewclsidx64.cab";
//设置高度
var height="94vh";
//设置宽度主密钥参数:
...
var downLoadFile = '或者下载安装<a href="./tags/exe/risesoftNTKOWord.exe">跨浏览器插件</a>';
...
NtkoJudgingBrowsers:function(){
	if("SetReturnValueToParentPage" in window.external){
	 return false;
	}else{
	  return true;
	}
