    ...
    <div class="indexlayout-top-tab-nav">
        ...
        <div class="down">
            ...
            <el-dropdown placement="bottom-end" @command="handleCommandMore">
                ...
                <template #dropdown>
                    <el-dropdown-menu>
                        <el-dropdown-item command="closeleft"><icon-svg class="icon-dropdown-menu" type="arrow-left2"  /> {{ $t('关闭左侧') }}</el-dropdown-item>
                        <el-dropdown-item command="closeright"><icon-svg class="icon-dropdown-menu" type="arrow-right2"  /> {{ $t('关闭右侧') }}</el-dropdown-item>
                        <el-dropdown-item command="closeother"><icon-svg class="icon-dropdown-menu" type="close"  /> {{ $t('关闭其他')}}</el-dropdown-item>
                        <el-dropdown-item command="closeall"><icon-svg class="icon-dropdown-menu" type="close2"  /> {{ $t('关闭所有') }}</el-dropdown-item>
