  ...
  <el-container v-loading="loading"
    ...
    <div :class="{ 'document-shrink': !processFlag}" class="document">
      ...
      <div style="margin-top: 104px">
        <!-- 表单 -->
        <newForm v-show="activeName == 'y9form'" ref="myForm" :basicData="basicData"
                 :processInstanceId="processInstanceId"/>
        <!-- 附件 -->
        <fileList v-if="activeName == 'attach'" ref="fileListRef" :basicData="basicData"
                  :processSerialNumber="processSerialNumber"/>
        <!-- 关联流程 -->
        <associatedFileList v-if="activeName == 'associatedFile'" ref="associatedFileListRef"
                            :basicData="basicData" :processSerialNumber="processSerialNumber"/>
        <!-- 沟通交流 -->
