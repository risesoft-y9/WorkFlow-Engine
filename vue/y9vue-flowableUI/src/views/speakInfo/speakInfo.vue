        ...
        <el-container style="height: 100%">
            ...
            >
                <div ref="chatForm" style="height: 45vh; overflow: auto">
                    <template v-if="speakInfoListData.length > 0" v-for="item in speakInfoListData">
                        <div v-if="item.userId == userId" class="speakInfocontent" v-bind:key="item.id">
                            <li>
                                <span class="rightTime">{{ item.createTime }}</span>
                                <div class="rightname">
                                    <span style="margin-right: 10px">{{ item.userName }}</span>
                                    <span
                                        ><el-avatar><img src="@/assets/avatar.png" :style="{fontSize: fontSizeObj.biggerrFontSize}" /></el-avatar
                                    ></span>
                                </div>
                            </li>
                            <li>
                        ...
                        <div v-else class="speakInfocontent" v-bind:key="item.id">
            ...
            <el-footer style="height: 35%">
                ...
                <el-row :gutter="20" style="text-align: right;">
                    <el-col :span="24">
                        <el-button type="primary" style="float: right" @click="save()" :size="fontSizeObj.buttonSize"
                            :style="{ fontSize: fontSizeObj.baseFontSize }">{{ $t('提交') }}</el-button>
                    </el-col>
                </el-row>
            </el-footer>
        </el-container>
...
<script lang="ts" setup>
    import { ref, defineProps, onMounted, watch,reactive,nextTick, inject} from 'vue';
    import { speakInfoList, saveSpeakInfo, delSpeakInfo } from '@/api/flowableUI/speakInfo';
