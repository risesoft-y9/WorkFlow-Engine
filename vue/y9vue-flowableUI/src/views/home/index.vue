            ...
            <div class="grid-content bg-white-color" style="padding: 45px; padding-bottom: 22px">
                <el-form :model="form" label-width="120px">
                    ...
                    <el-form-item label="所属地选择">
                        <el-select v-model="form.region" :size="fontSizeObj.buttonSize" placeholder="请选择企业所在地">
                            <el-option :style="{ fontSize: fontSizeObj.baseFontSize }" label="北京" value="beijing" />
                            <el-option :style="{ fontSize: fontSizeObj.baseFontSize }" label="上海" value="shanghai" />
                            <el-option :style="{ fontSize: fontSizeObj.baseFontSize }" label="深圳" value="shenzhen" />
                        </el-select>
                    </el-form-item>
    ...
    <el-row :gutter="20">
        ...
        <el-col :span="4">
            ...
            >
                ...
                <br />
                <el-button :size="fontSizeObj.buttonSize" :style="{ fontSize: fontSizeObj.baseFontSize }" type="success"
                    >成功色调
                </el-button>
                <br />
                <el-button :size="fontSizeObj.buttonSize" :style="{ fontSize: fontSizeObj.baseFontSize }" type="warning"
                    >警告色调
                </el-button>
                <br />
                <el-button :size="fontSizeObj.buttonSize" :style="{ fontSize: fontSizeObj.baseFontSize }" type="danger"
                    >错误色调
                </el-button>
                <br />
                <el-button :size="fontSizeObj.buttonSize" :style="{ fontSize: fontSizeObj.baseFontSize }" type="info"
                    >提示色调
                </el-button>
            </div>
        </el-col>
