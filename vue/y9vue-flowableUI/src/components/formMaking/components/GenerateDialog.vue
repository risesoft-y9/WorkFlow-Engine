<template>
  ...
  >
    ...
    <template #footer v-if="element.options.showCancel || element.options.showOk">
      <div>
        <el-button :size="sizeObjInfo.buttonSize" :style="{ fontSize: sizeObjInfo.baseFontSize }" v-if="element.options.showCancel" @click="handleCancel">{{element.options.cancelText}}</el-button>
        <el-button :size="sizeObjInfo.buttonSize" :style="{ fontSize: sizeObjInfo.baseFontSize }" type="primary" v-if="element.options.showOk" :loading="element.options.confirmLoading" @click="handleConfirm">{{element.options.okText}}</el-button>
      </div>
    </template>
  </el-dialog>
</template>
