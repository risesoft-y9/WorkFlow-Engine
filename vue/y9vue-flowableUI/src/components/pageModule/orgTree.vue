<template>
    <y9Card :showHeader="showHeader">
        <template #header>
            <y9Filter :filtersValueCallBack="filtersValueCallBack" :itemList="itemList" itemMarginBottom="0px">
                <template #refresh>
                    <el-button
        ...
        <y9Tree
            :isExpandAll="isExpandAllTree"
            :expandOnClickNode="true"
            :setting="orgTreeStore.getOrgTreeSetting"
        ></y9Tree>
    </y9Card>
</template>
...
<script lang="ts" setup>
    ...
    watch(
        () => props.treeApiObj.childLevel.api,
        (newVal, oldVal) => {
