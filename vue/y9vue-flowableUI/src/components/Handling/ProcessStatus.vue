    ...
    <div class="process-style">
        <div class="line-status">
            ...
            <template v-for="(item, index) in tabsList" :key="index">
                <div :style="{ height: index == 0 ? '50px' : '' }" class="node">
                    <!-- 竖线 -->
                    <div class="line"></div>
                    <!-- 线，点，时间等一些信息 -->
                    <div
                    ...
                    >
                        ...
                        <div
                            :class="{
                                'status-right': item.placement == 'right',
                                'status-left': item.placement == 'left',
                        ...
                        <div class="time">
                            ...
                            <div
                                v-else
                                :class="{
                                    'time-single-right': item.placement == 'right',
                                    'time-single-left': item.placement == 'left'
                                }"
                                class="time-single"
                            >
                                {{ item.timestamp }}
