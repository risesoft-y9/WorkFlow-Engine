...
//获取编号权限的配置
export function findByCustomNumber(itemId, processDefinitionId, taskDefKey) {
    const params = {
        itemId: itemId,
        processDefinitionId: processDefinitionId,
        taskDefKey: taskDefKey
    ...
    return flowableRequest({
        url: '/vue/organWord/findByCustomNumber',
        method: 'get',
        params: params
    });
}
...
//保存编号
export function saveNumberString(custom, itemId, numberString, processSerialNumber) {
    const params = {
        custom: custom,
        itemId: itemId,
        processSerialNumber: processSerialNumber,
    ...
    return flowableRequest({
        url: '/vue/organWord/saveNumberString',
        method: 'post',
        params: params
    });
}
