 ...
 * @LastEditTime: 2026-01-05 17:16:06
...
<script lang="ts" setup>
    ...
    onBeforeMount(() => {
        if (
            window.location.href.indexOf('/workIndex/') > -1 &&
            window.location.href.indexOf('/search/work') == -1 &&
            window.location.href.indexOf('/readIndex') == -1
        ) {
